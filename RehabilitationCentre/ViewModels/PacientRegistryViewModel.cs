...
{
    public class PacientRegistryViewModel : Screen
    {
        ...
        private PacientRegistryModel Model;
        ...
        public PacientRegistryViewModel(IWebClient webClient, IWindowManager theWindowManager, PacientRegistryModel model)
        {
            Model = model;
        ...
        protected override void OnInitialize()
        {
            ...
            try
            {
                ...
                Task.Run(async () =>
                {
                    ...
                    if (r != null)
                    {
                        Pacients = new BindableCollection<Pacient>(r);
                    }
                });
            }
            catch (Exception ex)
